...
export default function CheckinClient() {
  ...
  useEffect(() => {
    ...
    supabase
      ...
      .single()
      .then(({ data }) => {
        if (data) setSelectedCity(data as City);
      });
  }, [presetCityId]);
  ...
  return (
    <div className="page" style={{ background: "var(--bg)" }}>
      <div className="inner">
        ...
        {selectedCity ? (
          <div className="selected-city">
            <span>
              ...
              {selectedCity.name_local !== selectedCity.name_en
                ? ` · ${selectedCity.name_local}`
                : ""}{" "}
              ...
              <div className="search-results">
                {results.map((c) => (
                  ...
                  >
                    {c.name_en}
                    <div className="sub">
                      {c.name_local} · {c.country_code} · {c.region}
                    </div>
                  </div>
                ))}
              </div>
        ...
        >
          No location tracking. Your check-in is anonymous and auto-deleted after
          24 hours.
        </p>
      </div>
    </div>
